        ...
        <form action="/user/addproduct" method="POST" enctype="multipart/form-data">
            ...
            <div class="add-form-wrapper">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('brand_name') }}" placeholder="Brand Name" id="brand_name" type="text"
                ...
                <div class="form-group">
                    ...
                    <input value="{{ old('product_form') }}" placeholder="Product Form" id="product_form" type="text"
