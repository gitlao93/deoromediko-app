...
<div class="modal fade" id="update{{ $list->product_ID }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/user/update-prod" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="add-form-wrapper">
                ...
                <div class="form-group">
                    ...
                    <input value="{{$list->generic_name}}" placeholder="Generic Name" id="generic_name" type="text"
                ...
                <div class="form-group">
                    ...
                    <input value="{{$list->brand_name}}" placeholder="Brand Name" id="brand_name" type="text"
                ...
                <div class="form-group">
                    ...
                    <input value="{{$list->product_form}}" placeholder="Product Form" id="product_form" type="text"
                        class="form-control @error('product_form') is-invalid @enderror" name="product_form"
                        value="{{ old('product_form') }}"" autocomplete="product_form" autofocus>
                    @error('product_form')
                        <span class="invalid-feedback" role="alert" style="color: red;">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input value="{{$list->market_price}}" placeholder="Market Price" id="market_price"
                        ...
                        name="market_price" value="{{ old('market_price') }}"" autocomplete="market_price" autofocus>
                    @error('market_price')
                        <span class="invalid-feedback" role="alert" style="color: red;">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input value="{{$list->image_path}}" placeholder="Market Price" id="image_path" type="file"
